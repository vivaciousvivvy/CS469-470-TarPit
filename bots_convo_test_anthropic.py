...
from langchain_anthropic import ChatAnthropic  # New Anthropic import
...
scammer_llm = ChatAnthropic(
    model_name="claude-3-opus-20240229",  # or "claude-3-5-sonnet-20240620" for newer model
    temperature=1,
    max_tokens=4096  # Recommended for conversation
)
...
Be cautious but polite. Ask clarifying questions. Express mild interest but maintain skepticism."""
